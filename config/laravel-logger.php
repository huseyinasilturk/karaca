...
//    'loggerMiddlewareExcept'    => array_filter(explode(',', trim(env('LARAVEL_LOGGER_MIDDLEWARE_EXCEPT')))),
    'loggerMiddlewareExcept'    => array_filter(explode(',', env('LARAVEL_LOGGER_MIDDLEWARE_EXCEPT'))),
    ...
    |--------------------------------------------------------------------------
    */
    'logAllAuthEvents'      => true,   // May cause a lot of duplication.
    'logAuthAttempts'       => true,   // Successful and Failed -  May cause a lot of duplication.
    ...
    */
    ...
    'searchFields'  => env('LARAVEL_LOGGER_SEARCH_FIELDS', 'description,user,detail,method,route,ip'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'loggerPaginationEnabled' => env('LARAVEL_LOGGER_PAGINATION_ENABLED', false),
    ...
    */
    ...
    'loggerBladeExtended'       => env('LARAVEL_LOGGER_LAYOUT', 'layouts.fullLayoutMaster'),
