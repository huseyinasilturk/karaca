    ...
    D.fn.TouchSpin = function (k) {
        ...
        return this.each(function () {
            ...
            function h() {
                ...
                "" !== (t = i.callback_before_calculation(c.val()))
                    ? (0 < i.decimals && "." === t) ||
                      ((n = parseFloat(t)),
                      isNaN(n) &&
                          (n = "" !== i.replacementval ? i.replacementval : 0),
                      (o = n).toString() !== t && (o = n),
                      ...
                      (o = (function (t) {
                          switch (i.forcestepdivisibility) {
                              case "round":
                                  return (
                                      Math.round(t / i.step) * i.step
                                  ).toFixed(i.decimals);
                              case "floor":
                                  return (
                                      Math.floor(t / i.step) * i.step
                                  ).toFixed(i.decimals);
                              case "ceil":
                                  return (
                                      Math.ceil(t / i.step) * i.step
                                  ).toFixed(i.decimals);
                              default:
            ...
            function g() {
                ...
                var t,
                    n = (a = parseFloat(
                        i.callback_before_calculation(p.input.val())
                    ));
                isNaN(a) ? (a = x()) : ((t = v()), (a += t)),
                    null !== i.max &&
                        a > i.max &&
                    ...
                    p.input.val(
                        i.callback_after_calculation(
                            Number(a).toFixed(i.decimals)
                        )
                    ),
                ...
                (i = D.extend(
                    ...
                    (function () {
                        var t = c.val(),
                            n = c.parent();
                        "" !== t &&
                            (t = i.callback_after_calculation(
                                Number(t).toFixed(i.decimals)
                            ));
