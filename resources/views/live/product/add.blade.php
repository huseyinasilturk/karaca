                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input id="productName" class="form-control" name="name" type="text"
                                        placeholder="Ürün Adını Giriniz" autocomplete="off" required />
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="col-form-label"
                                            for="productListPrice{{ $firm->id }}">{{ $firm->name }} Liste
                                            Fiyatı</label>
                                        <input id="productListPrice{{ $firm->id }}" class="form-control"
                                            name="listPrice[{{ $firm->id }}]" type="number"
                                            placeholder="Liste Fiyatını Giriniz" min="0" step=".01" autocomplete="off"
                                            value="0" required />
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="col-12 mt-50">
                                <button type="submit"
                                    class="btn btn-primary me-1 waves-effect waves-float waves-light">Kaydet</button>
