            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if ("{{ auth()->user()->can('product.update') }}" === "1") {
                            elements += ` <a href="/product/edit/${full['id']}" class="btn bg-transparent p-0">${feather.icons["edit-2"].toSvg({
                                class: "font-small-4 text-primary",
                            })}</a>`
                        }

                        if ("{{ auth()->user()->can('product.delete') }}" === "1") {
                            elements += `  <button class="btn bg-transparent p-0" onclick="productDelete(this,${full["id"]})">${feather.icons["trash"].toSvg({
