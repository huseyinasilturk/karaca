...
<section id="ajax-datatable">
    ...
    <div class="modal fade" id="stokTransfer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                          <form class="form form-horizontal" method="POST" action="{{route("stockTransfer.transfer")}}">
                            @csrf
                            <div class="row">
                              <div class="col-12">
                                <div class="mb-1 row">
                              ...
                              <div class="col-sm-9 offset-sm-3">
                                <button type="submit" class="btn btn-primary me-1 waves-effect waves-float waves-light">Aktar</button>
                              </div>
                            </div>
                          </form>
                        </div>
