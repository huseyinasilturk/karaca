                ...
                <div class="card">
                    <div class="card-body">
                      <form id="formChangePassword" method="POST" onsubmit="return false">
                        <div class="alert alert-warning mb-2" role="alert" style="margin-top: -31px ">
                          <h6 class="alert-heading">Lütfen dikkat edin.</h6>
                          <div class="alert-body fw-normal">Minimum 8 karakter. Harf,şekil ve rakamlardan oluşan.</div>
