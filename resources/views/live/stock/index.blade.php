...
@section('content-sidebar')
    ...
    @section('content')
        ...
        <!-- Modal Starts -->
        <div class="modal fade text-start" id="stockModal" tabindex="-1" aria-labelledby="stockModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form onsubmit="stockFormHandler(event)">
                        ...
                        <div class="modal-body">
                            ...
                            <p class="stock-amount">Bu üründen stokta <span style="font-weight: bold">7</span> adet
                                bulunmakta
                            </p>
