...
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="demo-inline-spacing">
                            ...
                            <button type="button" class="btn btn-outline-primary" id="position-top-center">Top
                                Center</button>
                            <button type="button" class="btn btn-outline-primary" id="position-top-right">Top Right</button>
                            <button type="button" class="btn btn-outline-primary" id="position-top-full">Top Full
                                Width</button>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="demo-inline-spacing">
                            <button type="button" class="btn btn-outline-primary" id="position-bottom-left">Bottom
                                Left</button>
                            <button type="button" class="btn btn-outline-primary" id="position-bottom-center">Bottom
                                Center</button>
                            <button type="button" class="btn btn-outline-primary" id="position-bottom-right">Bottom
                                Right</button>
                            <button type="button" class="btn btn-outline-primary" id="position-bottom-full">Bottom Full
                                Width</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text mb-0">
                    You can use options like <code>showDuration</code>, <code>hideDuration</code>, <code>timeout</code> for
                    your
    ...
    <section id="toastr-animation">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text mb-0">
                    Use the jQuery <code>show/hide</code> method of your choice. These default to
                    <code>fadeIn/fadeOut</code>. The
                    methods <code>fadeIn/fadeOut</code>, <code>slideDown/slideUp</code>, and <code>show/hide</code> are
                    built into
                    jQuery.
                </p>
                <div class="demo-inline-spacing">
